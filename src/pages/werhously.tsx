    ...
    return (
        <>
            <Hero>
                ...
                <Hero.Description>
                    Werhously is a web-based platform for inbound and outbound warehouse operations. On this platform, warehouse owners and managers can onboard their warehouses for exclusive use within Agenpo's agribusiness ecosystem.
                </Hero.Description>
                ...
                <Hero.Image src="./assets/images/dashboard-ui-07.png" alt="dashboard-ui-07-image" />
            </Hero>
            ...
            <SolutionsSection>
                <SolutionsSection.Header title="FEATURES">
                    ...
                    <SolutionsSection.Description>
                        The warehouses are available to users of FarmSider, Korprativ and AgriGeitor when looking for their nearest available warehouse for the certification and sale of their produce. Being involved in the agribusiness ecosystem ensures a continuous flow of income to the warehouse. Approved warehouses will have met criteria such as the availability of security, insurance and internet connectivity.
                    </SolutionsSection.Description>
                </SolutionsSection.Header>
                <SolutionsSection.Body>
                    <SolutionsSection.Image src="./assets/images/dashboard-ui-08.png" alt="dashboard-ui-05-image" />
                </SolutionsSection.Body>
            </SolutionsSection>

            <Accordion title="FAQ" subTitle="Questions?" className="max-w-4xl mx-auto">
                <AccordionItem value="1" trigger="How do I register my warehouse to make it visible to various producers?">
                ...
                <AccordionItem value="2" trigger="How can I effectively monitor my warehouse operations?">
                ...
                <AccordionItem value="5" trigger="How do I receive payments on Werhously?">
            ...
            <section className="relative bg-white rounded-md w-full max-w-[1216px] mx-auto lg:px-0 overflow-hidden my-10 ">
                <div className="flex">
                    <div className="flex flex-col justify-center gap-4 w-full max-w-[576px] p-6">
                        ...
                        <p className=" text-gray-600 ">Manage warehouse logistics of produce end-to-end.</p>

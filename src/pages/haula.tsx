    ...
    return (
        <>
            <Hero>
                ...
                <Hero.Description>
                    Haula is fundamentally uber for logistics. Agribusiness logistics precisely. Incorporated transport logistics companies get a web-based platform to onboard and manage their drivers while their drivers use the Haula mobile app.
                </Hero.Description>
                ...
                <Hero.Image src="./assets/images/dashboard-ui-10.png" alt="dashboard-ui-10-image" />
            </Hero>
            ...
            <SolutionsSection>
                <SolutionsSection.Header title="FEATURES">
                    ...
                    <SolutionsSection.Description>
                        This product is fully integrated with Werhously and AceTraedr. Haula is essentially the technology gateway for entrepreneurs looking to get into agribusiness from the very critical transport logistics side . Receive coordinates from warehouses and off-takers for certified agricultural produce collection and delivery respectively.
                    </SolutionsSection.Description>
                ...
                <SolutionsSection.Body>
                    ...
                    <div className="flex items-center justify-center mb-10">
                        <div className="flex items-center bg-white rounded-full w-full md:w-fit">
                            <Link to={"#"} className="group flex items-center justify-center text-nowrap gap-3 w-full lg:w-fit px-6 py-3 rounded-2xl bg-primary hover:bg-opacity-90 text-white border border-transparent">
                                Logistic Company
                            </Link>
                            <Link to={"#"} className="flex items-center justify-center gap-3 w-full lg:w-fit px-6 py-3 rounded-r-2xl bg-white text-primary border border-transparent">
                                Truck
                            </Link>
                        </div>
                    </div>

                    <SolutionsSection.Image src="./assets/images/dashboard-ui-11.png" alt="dashboard-ui-11-image" />
                </SolutionsSection.Body>
            </SolutionsSection>
            ...
            <Accordion title="FAQ" subTitle="Questions?" className="max-w-4xl mx-auto">
                ...
                <AccordionItem value="3" trigger=" Do I have to pay to sign up on Haula?">
                    No, you do not pay to sign up, it's free.
                </AccordionItem>
                <AccordionItem value="4" trigger="Are the trucking companies/ Drivers on Haula vetted?">
                ...
                <AccordionItem value="5" trigger="What types of services does Haula offer?">
